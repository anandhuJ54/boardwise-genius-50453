  ...
  return (
    <section className="pt-32 pb-20 relative bg-gradient-to-b from-white to-gray-50">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-[40%] left-[15%] w-[35%] h-[35%] rounded-full bg-amber/10 filter blur-3xl opacity-40 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-[5%] right-[10%] w-[20%] h-[30%] rounded-full bg-amber-light/20 filter blur-2xl opacity-50 animate-float" style={{ animationDelay: '3s' }}></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={cn(
            ...
            Calculate board feet (bdft) quickly and accurately with our free Board Foot Calculator.
            Measure lumber volume precisely for any woodworking or construction project.
          </p>
