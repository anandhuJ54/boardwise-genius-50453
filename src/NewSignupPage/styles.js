...
export const SignupContainer1 = styled.div`
  ...
  *,
  ...
  :root {
    ...
    --ring: 217 91% 60%;
    --radius: 0.75rem;
    --brand-navy: 230 35% 13%;
    --brand-blue: 217 91% 60%;
    --brand-orange: 14 100% 60%;
    --brand-purple: 280 81% 60%;
    --brand-light-blue: 210 100% 92%;
    ...
    --shadow-md: 0 4px 6px -1px hsl(220 13% 91% / 0.5);
    --shadow-lg: 0 10px 15px -3px hsl(220 13% 91% / 0.4);
    --shadow-button: 0 4px 14px 0 hsl(217 91% 60% / 0.4);
  ...
  * {
  ...
  .bg-\[hsl\(0\,0\%\,23\%\)\] {
    --tw-bg-opacity: 1;
    background-color: hsl(0 0% 23% / var(--tw-bg-opacity, 1));
  }
  ...
  .from-\[\#5B8DEF\] {
    --tw-gradient-from: #5b8def var(--tw-gradient-from-position);
    --tw-gradient-to: rgb(91 141 239 / 0) var(--tw-gradient-to-position);
  ...
  .from-\[hsl\(14\,100\%\,60\%\)\] {
    --tw-gradient-from: hsl(14, 100%, 60%) var(--tw-gradient-from-position);
    --tw-gradient-to: hsl(14 100% 60% / 0) var(--tw-gradient-to-position);
    --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
  }

  .from-\[hsl\(217\,91\%\,95\%\)\] {
    --tw-gradient-from: hsl(217, 91%, 95%) var(--tw-gradient-from-position);
    --tw-gradient-to: hsl(217 91% 95% / 0) var(--tw-gradient-to-position);
    --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
  }
  ...
  .via-\[\#8B5A9D\] {
    --tw-gradient-to: rgb(139 90 157 / 0) var(--tw-gradient-to-position);
    --tw-gradient-stops: var(--tw-gradient-from),
      #8b5a9d var(--tw-gradient-via-position), var(--tw-gradient-to);
  }
  ...
  .to-\[\#5B8DEF\] {
    --tw-gradient-to: #5b8def var(--tw-gradient-to-position);
  }
  ...
  .to-\[hsl\(217\,91\%\,97\%\)\] {
    --tw-gradient-to: hsl(217, 91%, 97%) var(--tw-gradient-to-position);
  }

  .to-\[hsl\(280\,81\%\,60\%\)\] {
    --tw-gradient-to: hsl(280, 81%, 60%) var(--tw-gradient-to-position);
  }

  .to-\[hsl\(var\(--brand-purple\)\)\] {
  ...
  .shadow-\[var\(--shadow-button\)\] {
    --tw-shadow-color: var(--shadow-button);
  ...
  .hover\:bg-\[\#3A7BC8\]:hover {
    --tw-bg-opacity: 1;
    background-color: rgb(58 123 200 / var(--tw-bg-opacity, 1));
  }
...
export const SignupContainer = styled.div`
  background: linear-gradient(to Right, rgb(245, 249, 254), #fff);
  height: 100vh;
`
...
export const StyledText = styled.text`
  ...
  font-size: 24px;
`
export const VideoLinkConatiner = styled.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: center;
...
export const SearchInputContainer = styled.div`
  ...
  .ant-input:focus {
    border: 2px solid rgb(60, 131, 246) !important;
    outline: 2px solid rgb(60, 131, 246);
    outline-offset: 2px;
  }
...
`
export const ProfileLogoIcon = styled.div`
  color: rgb(255 255 255);
  font-weight: 600;
  font-size: 0.875rem;
  line-height: 1.25rem;
